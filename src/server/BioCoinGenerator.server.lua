...
-- Generate BioCoins for all online players
while true do
    wait(cooldown)
    for _, player in pairs(game.Players:GetPlayers()) do
        ...
        if coinAccumulator then
            coinAccumulator.Value = coinAccumulator.Value + coinAmount
        end
    end
    print("Generated BioCoins for all " .. #game.Players:GetPlayers() .. " players")
end
